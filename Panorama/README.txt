...
Step 3.) Estimate the optical flow more efficiently by scaling down the image size until it is less than a pixel, using Gaussian blending each ½ size decrementation from the original size.          
